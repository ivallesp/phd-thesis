...
\begin{table}[h!]
	...
	\begin{tabular}{lcccccc}
		\hline
		 & Ref. \autocite{Andrade2018} & Ref.  \autocite{Mcmahan2017}\footref{foot:max} & Ref. \autocite{Warden2018} & \textit{Xception-1d} & Human & p-value\footref{foot:ttest}      \\ \hline
...
\begin{tabular}{lcccccc}
	\hline
	            & Ref. \autocite{Andrade2018} &   Ref. \autocite{Zhang2017}\footnote{the  best results obtained among all the trials performed by the autors have been selected \label{foot:max}} & Ref. \autocite{Warden2018} &           \textit{Xception-1d}           &     Human    & p-value \footnote{Student's t-test for the comparison of two means. $\alpha = 0.05$ \label{foot:ttest}} \\ \hline
...
\section*{Appendix 1} \label{sec:kwsdwscost}
